...
import type { ISessionEventPublisher } from '@focus-sessions/domain/ports/session-event-publisher.port';
import type { SessionCompletedEvent } from '@focus-sessions/domain/events/session-completed.event';
import {
  SessionJobName,
  SESSIONS_QUEUE_NAME,
  type UpdateTaskDurationPayload,
} from '@focus-sessions/domain/types/session-jobs.types';
import {
