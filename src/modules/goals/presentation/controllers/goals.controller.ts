  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        estimatedEndDate: { type: 'string', format: 'date-time', example: '2026-12-31T00:00:00.000+05:30', description: 'ISO 8601 datetime with timezone' },
        estimatedDuration: { type: 'integer', example: 7200000, description: 'milliseconds — e.g. 7200000 = 2 hours' },
        estimatedStartDate: { type: 'string', format: 'date-time', example: '2026-06-01T00:00:00.000+05:30', description: 'ISO 8601 datetime with timezone' },
  ...
  @ApiBody({
    ...
    schema: {
      ...
      properties: {
        ...
        estimatedEndDate: { type: 'string', format: 'date-time', nullable: true, example: '2026-12-31T00:00:00.000+05:30', description: 'ISO 8601 datetime with timezone; null to clear' },
        estimatedDuration: { type: 'integer', nullable: true, example: 7200000, description: 'milliseconds; null to clear' },
        estimatedStartDate: { type: 'string', format: 'date-time', nullable: true, example: null, description: 'ISO 8601 datetime with timezone; null to clear' },
        actualStartDate: { type: 'string', format: 'date-time', nullable: true, example: null, description: 'ISO 8601 datetime with timezone; null to clear' },
        actualEndDate: { type: 'string', format: 'date-time', nullable: true, example: null, description: 'ISO 8601 datetime with timezone; null to clear' },
      },
    },
  })
