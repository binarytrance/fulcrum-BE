import type { GoalEstimatedEndDateChangedEvent } from '@goals/domain/events/goal-deadline-changed.event';
import type { GoalProgressRecomputeEvent } from '@goals/domain/events/goal-progress-recompute.event';

export type GoalEvent =
  | GoalEstimatedEndDateChangedEvent
  | GoalProgressRecomputeEvent;
