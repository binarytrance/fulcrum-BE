  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        scheduledFor: { type: 'string', format: 'date-time', example: '2026-05-08T09:00:00.000+05:30', description: 'ISO 8601 datetime with timezone — the date the user plans to work on this' },
        ...
        estimatedEndDate: { type: 'string', format: 'date-time', example: null, description: 'ISO 8601 datetime with timezone — optional target completion date' },
  ...
  @ApiBody({
    ...
    schema: {
      ...
      properties: {
        ...
        scheduledFor: { type: 'string', format: 'date-time', nullable: true, example: '2026-05-09T00:00:00.000+05:30', description: 'ISO 8601 datetime with timezone; null to clear' },
        estimatedEndDate: { type: 'string', format: 'date-time', nullable: true, example: null, description: 'ISO 8601 datetime with timezone; null to clear' },
        startDate: { type: 'string', format: 'date-time', nullable: true, example: null, description: 'ISO 8601 datetime with timezone; null to clear' },
